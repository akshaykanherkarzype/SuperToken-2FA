...
export function getApiDomain() {
    ...
    const apiUrl = process.env.REACT_APP_API_URL || `http://localhost:${apiPort}`;//ZYPE_DOMAIN
    return apiUrl;
}
...
SuperTokens.init({
    appInfo: {
        appName: `${process.env.REACT_APP_APP_NAME}`,//APP_NAME  //TODO: Your app name
        apiDomain: getApiDomain(), // TODO: Change to your app's API domain
        websiteDomain: getWebsiteDomain(), // TODO: Change to your app's website domain
    },
    getRedirectionURL: async (ctx) => {
        if (ctx.action === "TO_AUTH") {
            return "/auth?rid=emailpassword";
        }
    },
    recipeList: [
